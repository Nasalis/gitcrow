...
export function ContributorItem({collaborator}: Props) {
  ...
  return (
    <li className="relative flex items-center rounded-lg justify-start w-full h-24 gap-3 bg-black-100 hover:bg-black-200">
      <div className="flex items-center w-full h-full gap-3 p-3 transition-all overflow-hidden hover:scale-95">
        ...
        <div className="flex flex-col z-10">
          <a 
            ...
            target="_blank" 
            className="text-white-100 text-opacity-75 text-base font-medium cursor-pointer hover:underline"
          >
            {collaborator.name}
          </a>
          <footer className="mt-2">
            {collaborator.twitterUsername ? (
              <a 
                ...
                target="_blank"                
                className="flex items-center text-white-100 text-xs gap-x-2 cursor-pointer hover:underline"
              >
